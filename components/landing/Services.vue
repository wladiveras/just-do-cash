...
const page = reactive({
  features: {
    ...
    description: `Opte pela excelência. oferecemos serviços de qualidade superior, com uma equipe experiente e uma abordagem personalizada. Confie em nós para cuidar de você da melhor maneira possível.`,
    headline: 'Serviços',
    items: [
      {
