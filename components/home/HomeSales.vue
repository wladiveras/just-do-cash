...
<template>
  <UDashboardCard :title="t('dashboard.sales.recent.title')"
    :description="t('dashboard.sales.recent.description', { total: 313 })" icon="i-heroicons-chart-bar-20-solid">
    <NuxtLink v-for="(sale, index) in sales" :key="index"
